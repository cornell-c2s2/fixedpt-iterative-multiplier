...
#-------------------------------------------------------------------------
# HarnessVRTL__n_23__d_19
#-------------------------------------------------------------------------

class HarnessVRTL__n_23__d_19( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libHarnessVRTL__n_23__d_19_v.so', os.path.getmtime( './libHarnessVRTL__n_23__d_19_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libHarnessVRTL__n_23__d_19_v.so')

    # increment instance count
    HarnessVRTL__n_23__d_19.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        verilator_vcd_file = "rand_1_1_23_19_top_mult.verilator1.vcd"
      else:
        verilator_vcd_file = "HarnessVRTL__n_23__d_19.verilator1.vcd"
    ...
    s.recv = RecvIfcRTL( Bits46 )
    s.send = SendIfcRTL( Bits23 )
    ...
    s.s_DOT_recv_DOT_msg = Wire( Bits46 )
    @update
    ...
    s.s_DOT_send_DOT_msg = Wire( Bits23 )
    @update
