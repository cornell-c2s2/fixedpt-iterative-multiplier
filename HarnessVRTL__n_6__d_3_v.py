...
#-------------------------------------------------------------------------
# HarnessVRTL__n_6__d_3
#-------------------------------------------------------------------------

class HarnessVRTL__n_6__d_3( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libHarnessVRTL__n_6__d_3_v.so', os.path.getmtime( './libHarnessVRTL__n_6__d_3_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libHarnessVRTL__n_6__d_3_v.so')

    # increment instance count
    HarnessVRTL__n_6__d_3.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        verilator_vcd_file = "edge_top_mult.verilator1.vcd"
      else:
        verilator_vcd_file = "HarnessVRTL__n_6__d_3.verilator1.vcd"
    ...
    s.recv = RecvIfcRTL( Bits12 )
    s.send = SendIfcRTL( Bits6 )
    ...
    s.s_DOT_recv_DOT_msg = Wire( Bits12 )
    @update
    ...
    s.s_DOT_send_DOT_msg = Wire( Bits6 )
    @update
