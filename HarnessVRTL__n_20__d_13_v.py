...
#-------------------------------------------------------------------------
# HarnessVRTL__n_20__d_13
#-------------------------------------------------------------------------

class HarnessVRTL__n_20__d_13( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libHarnessVRTL__n_20__d_13_v.so', os.path.getmtime( './libHarnessVRTL__n_20__d_13_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libHarnessVRTL__n_20__d_13_v.so')

    # increment instance count
    HarnessVRTL__n_20__d_13.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        verilator_vcd_file = "rand_0_1_20_13_top_mult.verilator1.vcd"
      else:
        verilator_vcd_file = "HarnessVRTL__n_20__d_13.verilator1.vcd"
    ...
    s.recv = RecvIfcRTL( Bits40 )
    s.send = SendIfcRTL( Bits20 )
    ...
    s.s_DOT_recv_DOT_msg = Wire( Bits40 )
    @update
    ...
    s.s_DOT_send_DOT_msg = Wire( Bits20 )
    @update
