//========================================================================
// VHarnessVRTL__n_20__d_13_v.cpp
//========================================================================
...
#include "obj_dir_HarnessVRTL__n_20__d_13/VHarnessVRTL__n_20__d_13.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_HarnessVRTL__n_20__d_13/VHarnessVRTL__n_20__d_13__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VHarnessVRTL__n_20__d_13_t;

  // Exposed methods
  VHarnessVRTL__n_20__d_13_t * create_model( const char * );
  void destroy_model( VHarnessVRTL__n_20__d_13_t *);
  void comb_eval( VHarnessVRTL__n_20__d_13_t * );
  void seq_eval( VHarnessVRTL__n_20__d_13_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VHarnessVRTL__n_20__d_13_t *, char * );
  #endif
...
VHarnessVRTL__n_20__d_13_t * create_model( const char *vcd_filename ) {

  VHarnessVRTL__n_20__d_13_t * m;
  VHarnessVRTL__n_20__d_13   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VHarnessVRTL__n_20__d_13_t *) malloc( sizeof(VHarnessVRTL__n_20__d_13_t) );
  model = new VHarnessVRTL__n_20__d_13();
...
void destroy_model( VHarnessVRTL__n_20__d_13_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VHarnessVRTL__n_20__d_13 * model = (VHarnessVRTL__n_20__d_13 *) m->model;
...
void comb_eval( VHarnessVRTL__n_20__d_13_t * m ) {
...
void seq_eval( VHarnessVRTL__n_20__d_13_t * m ) {
...
#if VLINETRACE
void trace( VHarnessVRTL__n_20__d_13_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_HarnessVRTL___05Fn_20___05Fd_13__v );
