...
#include "obj_dir_HarnessVRTL__n_2__d_1/VHarnessVRTL__n_2__d_1.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_HarnessVRTL__n_2__d_1/VHarnessVRTL__n_2__d_1__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VHarnessVRTL__n_2__d_1_t;

  // Exposed methods
  VHarnessVRTL__n_2__d_1_t * create_model( const char * );
  void destroy_model( VHarnessVRTL__n_2__d_1_t *);
  void comb_eval( VHarnessVRTL__n_2__d_1_t * );
  void seq_eval( VHarnessVRTL__n_2__d_1_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VHarnessVRTL__n_2__d_1_t *, char * );
  #endif
...
VHarnessVRTL__n_2__d_1_t * create_model( const char *vcd_filename ) {

  VHarnessVRTL__n_2__d_1_t * m;
  VHarnessVRTL__n_2__d_1   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VHarnessVRTL__n_2__d_1_t *) malloc( sizeof(VHarnessVRTL__n_2__d_1_t) );
  model = new VHarnessVRTL__n_2__d_1();
...
void destroy_model( VHarnessVRTL__n_2__d_1_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VHarnessVRTL__n_2__d_1 * model = (VHarnessVRTL__n_2__d_1 *) m->model;
...
void comb_eval( VHarnessVRTL__n_2__d_1_t * m ) {
...
void seq_eval( VHarnessVRTL__n_2__d_1_t * m ) {
...
#if VLINETRACE
void trace( VHarnessVRTL__n_2__d_1_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_HarnessVRTL___05Fn_2___05Fd_1__v );
