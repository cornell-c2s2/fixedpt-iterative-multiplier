...
#-------------------------------------------------------------------------
# HarnessVRTL__n_2__d_1
#-------------------------------------------------------------------------

class HarnessVRTL__n_2__d_1( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libHarnessVRTL__n_2__d_1_v.so', os.path.getmtime( './libHarnessVRTL__n_2__d_1_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libHarnessVRTL__n_2__d_1_v.so')

    # increment instance count
    HarnessVRTL__n_2__d_1.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "HarnessVRTL__n_2__d_1.verilator1.vcd"
