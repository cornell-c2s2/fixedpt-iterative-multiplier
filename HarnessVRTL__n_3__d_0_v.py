...
#-------------------------------------------------------------------------
# HarnessVRTL__n_3__d_0
#-------------------------------------------------------------------------

class HarnessVRTL__n_3__d_0( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    #   'libHarnessVRTL__n_3__d_0_v.so', os.path.getmtime( './libHarnessVRTL__n_3__d_0_v.so' ) )

    # Import the shared library containing the model. We defer
    # construction to the elaborate_logic function to allow the user to
    # set the vcd_file.
    s._ffi_inst = s.ffi.dlopen('./libHarnessVRTL__n_3__d_0_v.so')

    # increment instance count
    HarnessVRTL__n_3__d_0.id_ += 1
  ...
  def construct( s, *args, **kwargs ):
    ...
    if 1:
      if True:
        ...
        verilator_vcd_file = "HarnessVRTL__n_3__d_0.verilator1.vcd"
    ...
    s.recv = RecvIfcRTL( Bits6 )
    s.send = SendIfcRTL( Bits3 )
    ...
    s.s_DOT_recv_DOT_msg = Wire( Bits6 )
    @update
    ...
    s.s_DOT_send_DOT_msg = Wire( Bits3 )
    @update
