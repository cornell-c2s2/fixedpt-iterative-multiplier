//========================================================================
// VHarnessVRTL__n_23__d_19_v.cpp
//========================================================================
...
#include "obj_dir_HarnessVRTL__n_23__d_19/VHarnessVRTL__n_23__d_19.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_HarnessVRTL__n_23__d_19/VHarnessVRTL__n_23__d_19__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VHarnessVRTL__n_23__d_19_t;

  // Exposed methods
  VHarnessVRTL__n_23__d_19_t * create_model( const char * );
  void destroy_model( VHarnessVRTL__n_23__d_19_t *);
  void comb_eval( VHarnessVRTL__n_23__d_19_t * );
  void seq_eval( VHarnessVRTL__n_23__d_19_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VHarnessVRTL__n_23__d_19_t *, char * );
  #endif
...
VHarnessVRTL__n_23__d_19_t * create_model( const char *vcd_filename ) {

  VHarnessVRTL__n_23__d_19_t * m;
  VHarnessVRTL__n_23__d_19   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VHarnessVRTL__n_23__d_19_t *) malloc( sizeof(VHarnessVRTL__n_23__d_19_t) );
  model = new VHarnessVRTL__n_23__d_19();
...
void destroy_model( VHarnessVRTL__n_23__d_19_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VHarnessVRTL__n_23__d_19 * model = (VHarnessVRTL__n_23__d_19 *) m->model;
...
void comb_eval( VHarnessVRTL__n_23__d_19_t * m ) {
...
void seq_eval( VHarnessVRTL__n_23__d_19_t * m ) {
...
#if VLINETRACE
void trace( VHarnessVRTL__n_23__d_19_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_HarnessVRTL___05Fn_23___05Fd_19__v );
